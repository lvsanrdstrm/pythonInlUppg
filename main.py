...
def sentiment_process_document(doc_to_process, doc_name):
    try:
        ...
        for match_id, start, end in matches:
            ...
            for sent in doc_to_process.sents:
                if start >= sent.start and end <= sent.end:
                    ...
                    match = SentimentSent(doc_name, matched_phrase, matched_sentence, polarity)
